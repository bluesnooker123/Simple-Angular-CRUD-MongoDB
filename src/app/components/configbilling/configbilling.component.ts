...
@Component({
  selector: 'app-configbilling',
  templateUrl: './configbilling.component.html',
  styleUrls: ['./configbilling.component.css']
})
export class ConfigBillingComponent implements OnInit {
  which_type = "day";
  title_text = "Billing Day";
  data = [];
  settings = {
    // selectMode: 'multi',
  ...
  ngOnInit(): void {
    ...
    if(this.which_type == "day")
      this.title_text = "Billing Day";
    else if(this.which_type == "batch")
      this.title_text = "Billing Batch";
    else if(this.which_type == "language")
      this.title_text = "Invoice Language";
    else if(this.which_type == "template")
      this.title_text = "Invoice Template";
    else if(this.which_type == "payment")
      this.title_text = "Payment After";
    this.read_BillingConfig();
  }
}
